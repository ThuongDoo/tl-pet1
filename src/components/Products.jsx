    ...
    <section id="products" className="scroll-mt-24 bg-slate-50 py-20">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {items.map((p) => (
            <div key={p.name} className="group overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-slate-100 transition hover:shadow-xl">
              ...
              <div className="p-5">
                ...
                <div className="mt-3 flex items-center justify-between">
                  <span className="text-lg font-extrabold text-secondary">{p.price}</span>
                  <button type="button" className="rounded-full bg-primary/10 px-4 py-1.5 text-xs font-semibold text-primary-dark transition hover:bg-primary hover:text-white">
                    Thêm vào giỏ
                  </button>
                </div>
              </div>
