    ...
    <section id="services" className="scroll-mt-24 bg-white py-20">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {main.map((s, i) => (
            <div key={s.title} className="group overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
              ...
              <div className="p-6">
                <div className="mb-3 inline-flex h-11 w-11 items-center justify-center rounded-full bg-primary/10 text-primary">
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d={MAIN_ICONS[i % MAIN_ICONS.length]} /></svg>
                </div>
